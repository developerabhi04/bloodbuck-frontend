...
export default function FirstBanners() {
    ...
    const handlePhotoUpload = e => {
        ...
        setPreviewPhotos(p => [...p, ...files.map(file => URL.createObjectURL(file))]);
    };
    ...
    const handleSubmit = async e => {
        ...
        try {
            if (isEditing) {
                await dispatch(updateBanners({ id: editingId, data })).unwrap();
                toast.success('Banner updated!');
            } else {
                await dispatch(addBanners(data)).unwrap();
